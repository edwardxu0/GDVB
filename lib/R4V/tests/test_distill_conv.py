...
class TestDistillConvolutionalNetwork(unittest.TestCase):
    ...
    def test_to_same(self):
        self.distill_and_check_accuracy("tests/test_distill_conv/conv_to_same.toml")

    def test_conv_to_fc(self):
        self.distill_and_check_accuracy("tests/test_distill_conv/conv_to_fc.toml")

    def test_conv_to_conv(self):
        self.distill_and_check_accuracy("tests/test_distill_conv/conv_to_conv.toml")
